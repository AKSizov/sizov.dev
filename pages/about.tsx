      ...
      <main className={`min-h-screen text-white ${inter.className}`}>
        ...
        <section className="text-neutral-400 bg-neutral-900/0 backdrop-brightness-50 body-font flex flex-col py-4 px-6" id='3'>
          <div className='my-16 flex flex-col lg:mx-16'>
            <h1 className='text-5xl text-white font-medium text-center my-2'>Projects</h1>
        ...
        <section className="text-neutral-400 bg-neutral-900/90 backdrop-brightness-50 body-font" id='resume'>
          <div className="px-6 py-8 mx-auto flex flex-col lg:flex-row justify-evenly items-center">
            <Image className="w-72 h-72 m-8" alt="hero" src={resheader} />
            <div className="flex flex-col justify-center">
              <h1 className="font-medium text-5xl text-white text-center lg:text-left">Resume</h1>
              <p className="text-xl my-4 text-center lg:text-left">
                Download my resume to view my work history, full list of skills, and more!
              </p>
              <a className='text-center lg:text-left' target="_blank" href='/sizov_resume.pdf'>
                <button className="text-white border-2 rounded border-violet-600 py-2 px-6 text-lg text-center w-full sm:w-auto my-4">Open resume.pdf -&gt;</button>
              </a>
            </div>
          </div>
        </section>
