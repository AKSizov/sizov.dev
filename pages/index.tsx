  ...
  return (
    <>
      ...
      <main className={`bg-zinc-900 min-h-screen text-white ${inter.className} dark`}>
        ...
        <footer className="p-4 bg-white sm:p-6 dark:bg-zinc-800">
          <div className="mx-auto max-w-screen-xl">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                <a href="#" className="flex items-center">
                  <Image src={se3} className="mr-3 h-8 w-8" alt="Sizov.dev Logo" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sizov.dev</span>
                </a>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                  ...
                  <ul className="text-zinc-600 dark:text-zinc-400">
                    <li className="mb-4">
                      <a href="#" className="hover:underline">Sizov.dev</a>
                    </li>
                    <li>
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-zinc-500 sm:text-center dark:text-zinc-400">© 2023 <a href="#" className="hover:underline">Sizov.dev</a>. All Rights Reserved.
              </span>
